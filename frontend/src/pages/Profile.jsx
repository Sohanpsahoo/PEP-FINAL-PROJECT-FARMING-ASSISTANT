              ...
              <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100" style={{ animation: 'slideUp 0.5s ease-out' }}>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center justify-between p-5 bg-gradient-to-r from-purple-50 to-fuchsia-50 rounded-2xl border border-purple-100/50 group hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-xl group-hover:scale-110 transition-transform">🗓️</div>
                  ...
                  <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-8 animate-fade-in" style={{ animationDuration: '0.3s' }}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <select name="language" value={formData.language || ''} onChange={(e) => { handleInputChange(e); changeLanguage(e.target.value); }} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 bg-gray-50 focus:bg-white transition-all font-medium appearance-none">
